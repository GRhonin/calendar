...
export default {
  ...
  methods: {
    initDate() {
      ...
      // 父组件给了数据
      if (this.defaultTime != "") {
        let dateArr = this.defaultTime.split("-");
        ...
        .select-item {
          ...
          .add-btn {
            ...
            .right-icon {
              ...
              width: 0;
              height: 0;
              border-top: px2rem(19) solid transparent;
              border-left: px2rem(38) solid #4169e1;
              border-bottom: px2rem(19) solid transparent;
            }
            .left-icon {
              position: absolute;
              top: px2rem(24);
              ...
              height: 0;
              border-top: px2rem(19) solid transparent;
              border-right: px2rem(38) solid #4169e1;
              border-bottom: px2rem(19) solid transparent;
            }
          }
          .center {
